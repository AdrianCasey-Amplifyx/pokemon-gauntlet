...
export const TRACKS: Record<Exclude<TrackId, "none">, TrackDef> = {
  ...
  battle_wild: { bpm: 185, channels: [BATTLE_WILD_MELODY, BATTLE_WILD_BASS] },
  battle_boss: { bpm: 185, channels: [BATTLE_BOSS_MELODY, BATTLE_BOSS_BASS] },
  battle_final: { bpm: 172, channels: [BATTLE_FINAL_MELODY, BATTLE_FINAL_BASS] },
};
