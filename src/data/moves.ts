...
// Accuracy values follow Gen 1 Bulbapedia where the move exists in Gen 1;
// non-Gen-1 moves (Aerial Ace, Sludge Bomb, Shadow Ball, Shadow Punch,
// Signal Beam, X-Scissor, Dragon Claw, Outrage, Ice Shard, Powder Snow,
// Mud-Slap, Megahorn, Cross Chop, Waterfall) use their canonical accuracy
// from the generation they were introduced in.
export const MOVES: Record<string, MoveData> = {
  // === NORMAL ===
  tackle: { id: "tackle", name: "Tackle", type: "normal", power: 25, accuracy: 95, cooldown: 0, category: "physical", description: "A basic charge." },
  ...
  bite: { id: "bite", name: "Bite", type: "normal", power: 40, accuracy: 100, cooldown: 1, category: "physical", description: "Bites with fangs. May flinch.", flinchChance: 0.1 },
  slam: { id: "slam", name: "Slam", type: "normal", power: 50, accuracy: 75, cooldown: 2, category: "physical", description: "Slams the foe." },
  ...
  take_down: { id: "take_down", name: "Take Down", type: "normal", power: 60, accuracy: 85, cooldown: 2, category: "physical", description: "A reckless charge. 25% recoil.", recoilRatio: 0.25 },
  ...
  hyper_beam: { id: "hyper_beam", name: "Hyper Beam", type: "normal", power: 85, accuracy: 90, cooldown: 3, category: "special", description: "A devastating beam." },
  ...
  wrap: { id: "wrap", name: "Wrap", type: "normal", power: 25, accuracy: 85, cooldown: 1, category: "physical", description: "Wraps and squeezes." },
  sing: { id: "sing", name: "Sing", type: "normal", power: 0, accuracy: 55, cooldown: 3, category: "special", description: "A soothing song. May put foe to sleep.", effect: { type: "sleep", chance: 0.55 } },
  lovely_kiss: { id: "lovely_kiss", name: "Lovely Kiss", type: "normal", power: 0, accuracy: 75, cooldown: 3, category: "special", description: "A scary kiss. May put foe to sleep.", effect: { type: "sleep", chance: 0.75 } },
  glare: { id: "glare", name: "Glare", type: "normal", power: 0, accuracy: 75, cooldown: 3, category: "special", description: "A terrifying glare. May paralyze.", effect: { type: "paralyze", chance: 0.75 } },
  headbutt: { id: "headbutt", name: "Headbutt", type: "normal", power: 45, accuracy: 100, cooldown: 1, category: "physical", description: "A ramming headbutt. May flinch.", flinchChance: 0.3 },
  double_edge: { id: "double_edge", name: "Double-Edge", type: "normal", power: 70, accuracy: 100, cooldown: 3, category: "physical", description: "A reckless tackle. 25% recoil.", recoilRatio: 0.25 },
  fury_attack: { id: "fury_attack", name: "Fury Attack", type: "normal", power: 15, accuracy: 85, cooldown: 0, category: "physical", description: "Jabs repeatedly — 2-5 hits.", multiHit: true },
  comet_punch: { id: "comet_punch", name: "Comet Punch", type: "normal", power: 18, accuracy: 85, cooldown: 0, category: "physical", description: "A flurry of punches — 2-5 hits.", multiHit: true },
  mega_punch: { id: "mega_punch", name: "Mega Punch", type: "normal", power: 50, accuracy: 85, cooldown: 2, category: "physical", description: "A powerful punch." },
  mega_kick: { id: "mega_kick", name: "Mega Kick", type: "normal", power: 70, accuracy: 75, cooldown: 3, category: "physical", description: "A powerful kick." },
  ...
  slash: { id: "slash", name: "Slash", type: "normal", power: 45, accuracy: 100, cooldown: 1, category: "physical", description: "Slashes sharply. High crit ratio.", highCrit: true },
  ...
  horn_drill: { id: "horn_drill", name: "Horn Drill", type: "normal", power: 0, accuracy: 30, cooldown: 3, category: "physical", description: "A one-hit KO if it lands.", ohko: true },
  stomp: { id: "stomp", name: "Stomp", type: "normal", power: 40, accuracy: 100, cooldown: 1, category: "physical", description: "Stomps hard. May flinch.", flinchChance: 0.3 },
  ...
  fire_blast: { id: "fire_blast", name: "Fire Blast", type: "fire", power: 80, accuracy: 85, cooldown: 3, category: "special", description: "An intense fire blast. May burn.", effect: { type: "burn", chance: 0.2 } },
  fire_spin: { id: "fire_spin", name: "Fire Spin", type: "fire", power: 25, accuracy: 70, cooldown: 1, category: "special", description: "Traps in fire." },
  ...
  hydro_pump: { id: "hydro_pump", name: "Hydro Pump", type: "water", power: 80, accuracy: 80, cooldown: 3, category: "special", description: "A massive torrent." },
  ...
  clamp: { id: "clamp", name: "Clamp", type: "water", power: 25, accuracy: 75, cooldown: 1, category: "physical", description: "Clamps the foe." },
  crabhammer: { id: "crabhammer", name: "Crabhammer", type: "water", power: 60, accuracy: 85, cooldown: 2, category: "physical", description: "A hammer claw. High crit ratio.", highCrit: true },
  ...
  razor_leaf: { id: "razor_leaf", name: "Razor Leaf", type: "grass", power: 40, accuracy: 95, cooldown: 1, category: "physical", description: "Sharp leaves. High crit ratio.", highCrit: true },
  solar_beam: { id: "solar_beam", name: "Solar Beam", type: "grass", power: 80, accuracy: 100, cooldown: 3, category: "special", description: "Charges 1 turn, then fires a beam of sunlight.", charge: true },
  mega_drain: { id: "mega_drain", name: "Mega Drain", type: "grass", power: 30, accuracy: 100, cooldown: 1, category: "special", description: "Drains HP — heals user for half the damage dealt.", drainRatio: 0.5 },
  ...
  absorb: { id: "absorb", name: "Absorb", type: "grass", power: 20, accuracy: 100, cooldown: 0, category: "special", description: "Drains a little HP.", drainRatio: 0.5 },
  sleep_powder: { id: "sleep_powder", name: "Sleep Powder", type: "grass", power: 0, accuracy: 75, cooldown: 3, category: "special", description: "May put foe to sleep.", effect: { type: "sleep", chance: 0.5 } },
  stun_spore: { id: "stun_spore", name: "Stun Spore", type: "grass", power: 0, accuracy: 75, cooldown: 3, category: "special", description: "May paralyze.", effect: { type: "paralyze", chance: 0.6 } },
  poison_powder: { id: "poison_powder", name: "Poison Powder", type: "grass", power: 0, accuracy: 75, cooldown: 3, category: "special", description: "Toxic spores. May poison.", effect: { type: "poison", chance: 0.75 } },
  ...
  leech_seed: { id: "leech_seed", name: "Leech Seed", type: "grass", power: 0, accuracy: 90, cooldown: 3, category: "special", description: "Plants a seed that drains HP each turn and heals user.", leechSeed: true },
  ...
  thunder: { id: "thunder", name: "Thunder", type: "electric", power: 80, accuracy: 70, cooldown: 3, category: "special", description: "A devastating bolt. May paralyze.", effect: { type: "paralyze", chance: 0.15 } },
  ...
  // === ROCK ===
  rock_throw: { id: "rock_throw", name: "Rock Throw", type: "rock", power: 35, accuracy: 65, cooldown: 1, category: "physical", description: "Hurls a rock." },
  rock_slide: { id: "rock_slide", name: "Rock Slide", type: "rock", power: 55, accuracy: 90, cooldown: 2, category: "physical", description: "Boulders crash down." },
  ...
  // === PSYCHIC ===
  confusion: { id: "confusion", name: "Confusion", type: "psychic", power: 35, accuracy: 100, cooldown: 1, category: "special", description: "Telekinetic attack. May confuse.", effect: { type: "confuse", chance: 0.1 } },
  psybeam: { id: "psybeam", name: "Psybeam", type: "psychic", power: 45, accuracy: 100, cooldown: 1, category: "special", description: "A psychic beam. May confuse.", effect: { type: "confuse", chance: 0.1 } },
  ...
  hypnosis: { id: "hypnosis", name: "Hypnosis", type: "psychic", power: 0, accuracy: 60, cooldown: 3, category: "special", description: "Hypnotic gaze. May cause sleep.", effect: { type: "sleep", chance: 0.6 } },
  ...
  smog: { id: "smog", name: "Smog", type: "poison", power: 25, accuracy: 70, cooldown: 0, category: "special", description: "Noxious gas." },
  toxic: { id: "toxic", name: "Toxic", type: "poison", power: 0, accuracy: 85, cooldown: 3, category: "special", description: "Badly poisons.", effect: { type: "poison", chance: 0.9 } },
  poison_gas: { id: "poison_gas", name: "Poison Gas", type: "poison", power: 0, accuracy: 55, cooldown: 3, category: "special", description: "A cloud of poison gas.", effect: { type: "poison", chance: 0.55 } },
  ...
  rolling_kick: { id: "rolling_kick", name: "Rolling Kick", type: "fighting", power: 40, accuracy: 85, cooldown: 1, category: "physical", description: "A spinning kick. May flinch.", flinchChance: 0.3 },
  counter: { id: "counter", name: "Counter", type: "fighting", power: 0, accuracy: 100, cooldown: 2, category: "physical", description: "Returns twice the physical damage taken this turn.", counter: true },
  bide: { id: "bide", name: "Bide", type: "normal", power: 0, accuracy: 100, cooldown: 3, category: "physical", description: "Stores damage for 2 turns, then unleashes double.", bide: true },
  rollout: { id: "rollout", name: "Rollout", type: "rock", power: 30, accuracy: 90, cooldown: 1, category: "physical", description: "Each consecutive hit doubles in power.", rollout: true },
  ...
  fly: { id: "fly", name: "Fly", type: "flying", power: 55, accuracy: 95, cooldown: 2, category: "physical", description: "Turn 1: soars high (untargetable). Turn 2: dives for an attack.", semiInvulnerable: true },
  sky_attack: { id: "sky_attack", name: "Sky Attack", type: "flying", power: 75, accuracy: 90, cooldown: 3, category: "physical", description: "Charges 1 turn then dives.", charge: true },
  ...
  blizzard: { id: "blizzard", name: "Blizzard", type: "ice", power: 80, accuracy: 90, cooldown: 3, category: "special", description: "A howling blizzard." },
