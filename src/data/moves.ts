...
export const MOVES: Record<string, MoveData> = {
  ...
  take_down: { id: "take_down", name: "Take Down", type: "normal", power: 60, accuracy: 85, cooldown: 2, category: "physical", description: "A reckless charge." },
  ...
  fury_attack: { id: "fury_attack", name: "Fury Attack", type: "normal", power: 25, accuracy: 85, cooldown: 0, category: "physical", description: "Jabs repeatedly." },
  comet_punch: { id: "comet_punch", name: "Comet Punch", type: "normal", power: 25, accuracy: 85, cooldown: 0, category: "physical", description: "A flurry of punches." },
  ...
  horn_drill: { id: "horn_drill", name: "Horn Drill", type: "normal", power: 80, accuracy: 30, cooldown: 3, category: "physical", description: "A drilling horn attack." },
  ...
  crabhammer: { id: "crabhammer", name: "Crabhammer", type: "water", power: 60, accuracy: 85, cooldown: 2, category: "physical", description: "A hammer claw." },
  ...
  razor_leaf: { id: "razor_leaf", name: "Razor Leaf", type: "grass", power: 40, accuracy: 95, cooldown: 1, category: "physical", description: "Sharp leaves." },
  ...
  leech_seed: { id: "leech_seed", name: "Leech Seed", type: "grass", power: 20, accuracy: 90, cooldown: 1, category: "special", description: "Plants a seed." },
  ...
  bonemerang: { id: "bonemerang", name: "Bonemerang", type: "ground", power: 55, accuracy: 90, cooldown: 2, category: "physical", description: "Throws a boomerang bone." },
  fissure: { id: "fissure", name: "Fissure", type: "ground", power: 80, accuracy: 30, cooldown: 3, category: "physical", description: "Opens a crack." },
  ...
  low_kick: { id: "low_kick", name: "Low Kick", type: "fighting", power: 35, accuracy: 90, cooldown: 1, category: "physical", description: "A sweeping kick." },
  ...
  submission: { id: "submission", name: "Submission", type: "fighting", power: 50, accuracy: 80, cooldown: 2, category: "physical", description: "A body slam." },
  cross_chop: { id: "cross_chop", name: "Cross Chop", type: "fighting", power: 65, accuracy: 80, cooldown: 2, category: "physical", description: "A double chop." },
  ...
  rolling_kick: { id: "rolling_kick", name: "Rolling Kick", type: "fighting", power: 40, accuracy: 85, cooldown: 1, category: "physical", description: "A spinning kick." },
  ...
  fly: { id: "fly", name: "Fly", type: "flying", power: 55, accuracy: 95, cooldown: 2, category: "physical", description: "Flies up then strikes." },
  sky_attack: { id: "sky_attack", name: "Sky Attack", type: "flying", power: 75, accuracy: 90, cooldown: 3, category: "physical", description: "A powerful dive." },
  ...
  // === BUG ===
  string_shot: { id: "string_shot", name: "String Shot", type: "bug", power: 20, accuracy: 95, cooldown: 0, category: "special", description: "Shoots sticky string." },
  ...
  pin_missile: { id: "pin_missile", name: "Pin Missile", type: "bug", power: 35, accuracy: 95, cooldown: 1, category: "physical", description: "Sharp pins fly." },
